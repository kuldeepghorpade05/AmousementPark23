...
<html>
<head>
<title>DJ Nights | Admin manage Issues</title>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/AmousementPark21/ADMIN//updateissue.php?iid=<?php echo ($result->id);?>');">View </a>
</td>
